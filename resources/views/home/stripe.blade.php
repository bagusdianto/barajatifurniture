...
<div class="container">    
    ...
    <h1 style="text-align: center; font-size: 24px; padding-bottom: 20px;">Bayar menggunakan keranjang belanja Anda - Total jumlah ${{$totalprice}}<br/></h1> 
                    ...
                    <form 
                        ...
                        <input autocomplete='off' class='form-control card-cvc' placeholder='ex. 311' size='4'
                            ...
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                ...
                                <label class='control-label'>Bulan Kedaluwarsa</label> 
                        <input class='form-control card-expiry-month' placeholder='MM' size='2'
                            ...
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                ...
                                <label class='control-label'>Tahun Kedaluwarsa</label> 
